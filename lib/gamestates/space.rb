  ...
  module Gamestates
    class Space < Chingu::GameState
      ...
      def initialize
        ...
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 4, :y => 1))
        ...
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 1, :y => 3))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 2, :y => 3))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 3, :y => 3))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 4, :y => 3))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 5, :y => 3))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 0, :y => 4))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 1, :y => 4))
        ship.bolt_on(Spacestuff::Game::EnginePiece.new(:x => 2, :y => 4))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 3, :y => 4))
        ship.bolt_on(Spacestuff::Game::EnginePiece.new(:x => 4, :y => 4))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 5, :y => 4))
        ship.bolt_on(Spacestuff::Game::HullPiece.new(:x => 6, :y => 4))
